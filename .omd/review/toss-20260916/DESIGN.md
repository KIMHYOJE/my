...
|---|---|---|---|---|---|
| project-evidence-images | image | project-owned | unresolved | public/evidence | 저장소에 제공된 포스터·로고·웹앱·AI 자료·게임잼 이미지 |
| certificate-pdf | other | user-provided | unresolved | public/evidence/certificate-hyoje.pdf | 별도 열람 링크로 연결 |
