...
- color-canvas on color-primary: minimum 3:1
...
- 일반 본문 텍스트는 WCAG AA 이상, 큰 액션 텍스트는 3:1 이상을 목표로 한다
<!-- design-md:claim-end -->
...
|---|---|---|---|---|---|
| system-font-fallback | font | official | not-required | OS-provided system font stack | 프로젝트에 폰트 파일을 번들하지 않음 |
